...
- Google Cloud Professional Developer (2020)`;
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-center mb-8">Resume Assistant</h2>
      ...
      {step === 2 && (
        <div className="flex flex-col items-center">
          <div className="w-full max-w-lg">
            <h3 className="text-xl font-semibold mb-4">Enter Job Description</h3>
      ...
      {step === 3 && (
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-semibold mb-6">What would you like to do with your resume?</h3>
      ...
      {step === 4 && (
        <div className="flex flex-col items-center">
          ...
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 w-full mb-8 prose max-w-none">
            <div dangerouslySetInnerHTML={{ 
              __html: result.replace(/^# (.*$)/gm, '<h2>$1</h2>')
                          .replace(/^## (.*$)/gm, '<h3>$1</h3>')
                          .replace(/^### (.*$)/gm, '<h4>$1</h4>')
                          .replace(/\n/g, '<br>')
